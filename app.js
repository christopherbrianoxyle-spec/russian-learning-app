...
(function () {
    ...
    `;
        ...
        // Ajouter les événements audio après création du HTML
    ...
    function openModal(id) {
        ...
        // Configurer les événements audio de la modal
    ...
    function playAudio(text, language, buttonElement = null) {
        ...
        // Créer une nouvelle instance de speech
        ...
        // Essayer de trouver une voix native pour la langue
    ...
    // Fonction globale pour les boutons onclick
    window.playAudio = playAudio;

    // Arrêter l'audio si l'utilisateur quitte la page
